...
var ADMIN_PASSWORD = process.env.DASHBOARD_PASS;
async function handler(event, context) {
  ...
  try {
    ...
    if (password === ADMIN_PASSWORD) {
      const authCookie = (0, import_cookie.serialize)("nf_auth", "true", {
        //
        ...
        //
        secure: true,
        // Hanya kirim via HTTPS (saat di-deploy)
        sameSite: "strict",
        // Batasi cookie hanya untuk domain ini
        path: "/",
        maxAge: 60 * 60 * 24
        // Masa berlaku cookie: 1 hari
      });
      return {
        statusCode: 200,
        headers: {
