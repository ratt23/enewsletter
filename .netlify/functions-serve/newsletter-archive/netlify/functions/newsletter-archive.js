...
// netlify/functions/newsletter-archive.js
var newsletter_archive_exports = {};
__export(newsletter_archive_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(newsletter_archive_exports);
...
async function handler(event, context) {
  ...
  if (event.httpMethod === "GET") {
    try {
      ...
      const whereClause = sql`WHERE is_published = true`;
...
//# sourceMappingURL=newsletter-archive.js.map
