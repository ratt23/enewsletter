...
// ../netlify/functions/getLeaveData.js
var getLeaveData_exports = {};
__export(getLeaveData_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getLeaveData_exports);
...
async function handler(event, context) {
  const headers = {
    ...
    // Ganti '*' dengan URL publik Anda saat deploy
    "Access-Control-Allow-Methods": "GET",
    "Content-Type": "application/json",
    "Cache-Control": "public, max-age=600, s-maxage=600"
    // Cache 10 menit (browser & CDN)
  };
  try {
...
//# sourceMappingURL=getLeaveData.js.map
