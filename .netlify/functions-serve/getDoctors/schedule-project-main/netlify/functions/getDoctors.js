...
// ../netlify/functions/getDoctors.js
var getDoctors_exports = {};
__export(getDoctors_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getDoctors_exports);
