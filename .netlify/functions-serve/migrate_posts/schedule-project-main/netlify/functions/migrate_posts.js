...
// ../netlify/functions/migrate_posts.js
var migrate_posts_exports = {};
__export(migrate_posts_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(migrate_posts_exports);
...
//# sourceMappingURL=migrate_posts.js.map
