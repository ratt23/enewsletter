...
// ../netlify/functions/newsletter-upsert.js
var newsletter_upsert_exports = {};
__export(newsletter_upsert_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(newsletter_upsert_exports);
...
async function handler(event, context) {
  ...
  try {
    ...
    if (yearInt < 2e3 || yearInt > 2100 || monthInt < 1 || monthInt > 12) {
      return {
        statusCode: 400,
        headers,
...
//# sourceMappingURL=newsletter-upsert.js.map
