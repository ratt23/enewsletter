...
// ../netlify/functions/migrate_mcu.js
var migrate_mcu_exports = {};
__export(migrate_mcu_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(migrate_mcu_exports);
...
// ../netlify/functions/migrate_mcu.js
var handler = async () => {
  const sql = src_default(process.env.NEON_DATABASE_URL, { ssl: "require" });
  try {
    ...
    const seedData = [
      {
        ...
        addons: [
          { id: "golongan_darah", label: "Golongan Darah", price: 5e4 },
          { id: "IGM", label: "IGM Anti HAV", price: 3e5 }
        ]
      },
      {
        package_id: "basic",
...
//# sourceMappingURL=migrate_mcu.js.map
